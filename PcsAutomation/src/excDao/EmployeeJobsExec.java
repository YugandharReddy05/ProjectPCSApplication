...
public class EmployeeJobsExec{
	...
	JobController empController=null;
	
	public EmployeeJobsExec() {
		empController=new JobController();
	}
	
	public void getAllEmployeeskill() {
		List<EmpJob> empList=empController.getAllEmployeeskill();
		for(EmployeeJobsExec emp:empList) {
	...
	public void getEmployeeskillById() {
		...
		EmployeeJobsExec emp=empController.getEmployeeskillById(id);
		System.out.println(emp);
	}
